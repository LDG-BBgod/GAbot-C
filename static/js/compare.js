...
function getTimeFuntion(){
    ...
    if (document.hidden) {
        ...
        function DotTwoTimeCheck() {
            $.ajax({type: 'GET', url: '/gettime/', dataType: 'json', data: {'data': 0.2, 'dataType': 'compareStayTime'}})
        }
        function oneTimeCheck() {
            ...
            $.ajax({type: 'GET', url: '/gettime/', dataType: 'json', data: {'data': data, 'dataType': 'compareStayTime'}})
        }
