...
function getTimeFuntion(){
    ...
    function DotTwoTimeCheck() {
        $.ajax({type: 'GET', url: '/gettime/', dataType: 'json', data: {'data': 0.2, 'dataType': 'consultingStayTime'}})
    }
    function oneTimeCheck() {
        ...
        $.ajax({type: 'GET', url: '/gettime/', dataType: 'json', data: {'data': data, 'dataType': 'consultingStayTime'}})
    }
